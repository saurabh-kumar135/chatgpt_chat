    ...
    try:
        if name == "vercel_list_projects":
            ...
            return {
                ...
                "nodeVersion": res.get("nodeVersion"),
                "rootDirectory": res.get("rootDirectory"),
                "updatedAt": res.get("updatedAt"),
                "targets": res.get("targets", {}),
                "link": {
                    "type": res.get("link", {}).get("type"),
                    "repo": res.get("link", {}).get("repo"),
                    "productionBranch": res.get("link", {}).get("productionBranch")
                } if res.get("link") else None
            }
